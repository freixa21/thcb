            ...
            <div class="w-full">
                <div id="bloc-principal" class="flex flex-col lg:flex-row">
                    <div id="informacio" class="w-full lg:w-1/2 shadow-md  p-3 rounded-lg mb-5 lg:mb-0">
                        <a href="{{ route('admin.equips') }}"><i class="fa-solid fa-arrow-left"></i><span> Tornar a
                                equips</span></a>
                        <h1 class="mr-2 mb-2">{{ $equipo->nombre }}</h1>
                        <p><strong>Nom capità: </strong> {{ $usuarioEquip->name }} {{ $usuarioEquip->apellidos }} </p>
                        <p><strong>Correu electrònic:</strong> {{ $usuarioEquip->email }} </p>
                        <p><strong>Telèfon:</strong> {{ $usuarioEquip->phone }} </p>
                    </div>
                    <!-- ====== Modal Section Start -->
                    <div id="estat-inscripcio" class="flex flex-col shadow-md  p-3 rounded-lg w-full lg:w-1/2">
                        ...
                        <div class="flex flex-col">
                            ...
                            @if (count($jugadores) > 4)
                                <form action="{{ route('admin.uploadComprovant') }}" method="POST"
                    ...
                    @elseif($equipo->estado_inscripcion == 1)
                        <div class="estat-1 mt-3 mb-2">Pagament realitzat. Validació en procés.</div>
                        <a href="{{ asset('images/uploads/' . $equipo->comprovante_img) }}"class="text-xs mt-2 underline"
                            target="_blank">Veure
                    ...
                    @elseif($equipo->estado_inscripcion == 2)
                    ...
                    @endif
                    <form action="{{ route('admin.eliminarInscripcioEquip') }}" method="POST" class="mt-8 mb-0">
                        @csrf
                        @method('DELETE')
                        <input type="hidden" name="id" value="{{ $equipo->id }}">
                        <button type="submit"
            ...
            <section x-data="{ modalOpen: false }" id="instruccions">
                ...
                <div x-show="modalOpen" x-transition style="z-index: 1"
                    ...
                    <div @click.outside="modalOpen = false"
                        ...
                        <form autocomplete="on" action="{{ route('admin.afegirJugador') }}" method="POST" class="mb-2">
                            @csrf
                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-1 rounded-md shadow-sm">
                                    <input required id="name-afegir" name="name" type="text" required="" autofocus
                                ...
                                <section x-data="{ modalOpen: false }" id="instruccions">
                                    ...
                                    <div x-show="modalOpen" x-transition style="z-index: 1"
                                        ...
                                        <div @click.outside="modalOpen = false"
                                            ...
                                            <form autocomplete="on" action="{{ route('admin.actualizarJugador') }}"
                                                            ...
                                                            <div class="relative flex items-start w-full">
                                                                <div class="flex items-center h-5">
                                                                    <input required id="XS-{{ $loop->index }}"
                                                                        value="XS" name="talla" type="radio"
                                                                        class="border-gray-200 rounded-full :bg-gray-800 :border-gray-700 :checked:bg-blue-500 :checked:border-blue-500 :focus:ring-offset-gray-800"
                                                            ...
                                                            <div class="relative flex items-start w-full">
                                                                <div class="flex items-center h-5">
                                                                    <input required id="XL-{{ $loop->index }}"
                                                                        value="XL" name="talla" type="radio"
                                                                        class="border-gray-200 rounded-full :bg-gray-800 :border-gray-700 :checked:bg-blue-500 :checked:border-blue-500 :focus:ring-offset-gray-800"
                                                            ...
                                                            <div class="relative flex items-start w-full">
                                                                <div class="flex items-center h-5">
                                                                    <input required id="XXL-{{ $loop->index }}"
                                                                        value="XXL" name="talla" type="radio"
                                                                        class="border-gray-200 rounded-full :bg-gray-800 :border-gray-700 :checked:bg-blue-500 :checked:border-blue-500 :focus:ring-offset-gray-800"
                                            ...
                                            <div class="-mx-3 flex flex-wrap mb-2">
                                                <div class="w-full px-3">
                                                    <form action="{{ route('admin.eliminarJugador', $jugador->id) }}"
