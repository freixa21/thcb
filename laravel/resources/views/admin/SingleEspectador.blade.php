            ...
            <div class="w-full">
                <div id="bloc-principal" class="flex flex-col lg:flex-row mt-4">
                    ...
                    <div id="estat-inscripcio" class="flex flex-col shadow-md  p-3 rounded-lg w-full lg:w-1/3">
                        ...
                        <div class="flex flex-col">
                            <form action="{{ route('admin.espectadorComprovant') }}" method="POST"
                    ...
                    @elseif($espectador->estado_inscripcion == 1)
                        ...
                        <a href="{{ asset('images/uploads/' . $espectador->comprovante_img) }}"class="text-xs mt-2 underline"
                            target="_blank">Veure
                    ...
                    <form action="{{ route('admin.eliminarInscripcioEspectador', $espectador->id) }}" method="POST"
                        class="mb-0">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
