...
Route::get("admin/espectadors/validar/{id}", [AdminEspectadorController::class, "validarInscripcio"])->name('admin.validarInscripcioEspectador');
...
Route::delete("admin/eliminar-espectador/{id}", [AdminEspectadorController::class, "eliminarInscripcioEspectador"])->name('admin.eliminarInscripcioEspectador');
